...
IoExtenders::Mcp23017_ControlPin::Mcp23017_ControlPin(IoExtenders::Mcp23017* extender, IoExtenders::Mcp23017::Bank bank, int pinNumber):
    _extender(extender), _bank(bank), _pinNumber(pinNumber)
{
    extender->set_pin_as_output(bank, pinNumber);
};

void IoExtenders::Mcp23017_ControlPin::set_pin_state(ControlPins::DigitalControlPin::PinState newPinState)
{
